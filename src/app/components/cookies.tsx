...
export default function Cookies(): ReactElement | null {
    ...
    return (
        ...
        >
            <div
                className="p-4 bg-white/[.6] backdrop-blur-lg rounded-xl shadow-2xl dark:bg-slate-900/[.6] dark:shadow-black/[.7]">
